...
src/ domain/ # Entities, value objects, types application/ # Use cases, business logic, services infrastructure/ # API clients, adapters, data sources presentation/ # UI components, hooks, pages main.tsx app.tsx
...
This UI is part of a thesis project focused on modeling and simulating mobility behaviors of homeless individuals in Santiago de Cali. The interface communicates with the Python backend to execute simulations, retrieve grid states, and visualize transitions produced by the Cellular Automata engine.
